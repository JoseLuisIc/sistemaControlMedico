...
//    String Password="admin";
    ...
    public loginInMedico() {
        initComponents();
        clog.escribirLog("SistemaLogger.log", "Usuario: Actividad: Se inicia logInMedico()");
    }
     public void ValidarAcceso(){
        clog.escribirLog("SistemaLogger.log", "Usuario: Actividad: Se inicia ValidarAcceso()");
        int resultado=0;
        try {
          String usuario=jTextNombre.getText();
          String pass=String.valueOf(jPasswordField1.getPassword());
          clog.escribirLog("SistemaLogger.log", "Usuario: Actividad: Se inicia ingresa: usuario"+usuario);
                    
          String sql= "select * from tabla_usuarios where username='"+usuario+"' and password='"+pass+"' ";
          clog.escribirLog("SistemaLogger.log", "Usuario: Actividad: Se Ejecuta la consulta: "+sql);
...
//          }
          if(resultado==1){
                ...
                clog.escribirLog("SistemaLogger.log", "Usuario: Actividad: No se puede iniciar sesión con el usuario:"+usuario);
            }
